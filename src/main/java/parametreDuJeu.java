...
public class parametreDuJeu {
    ...
    public static void presenter(){
        System.out.println("----------------------------------------------------------------------");
        System.out.println("----------------------------------------------------------------------");
        System.out.println("------------Bienvenur dans le jeu <<< Recherhce +/- >>>---------------");
        System.out.println("-------------Le joueur attaquant choisi une combinaison-------------- ");
        System.out.println("---Le joueur defenseur doit la trouver en un nombre maximal d'essai---");
        System.out.println("----------------------------------------------------------------------");
